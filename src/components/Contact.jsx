                        ...
                        <div className="relative">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-ink-100 p-1">
                                <form className="space-y-4 p-6 sm:p-8" onSubmit={(e) => e.preventDefault()}>
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                ...
                                                <input type="text" className="w-full px-4 py-3 bg-ink-50/50 rounded-lg border border-ink-100 focus:bg-white focus:border-accent-blue focus:ring-2 focus:ring-accent-blue/10 outline-none transition-all duration-300 text-sm font-medium text-ink-700 placeholder-ink-300" placeholder="your name" />
                                            </div>
                                            <div className="space-y-1.5">
                                                <label className="font-heading text-[0.6rem] font-bold text-ink-400 uppercase tracking-wider ml-1">Email</label>
                                                <input type="email" className="w-full px-4 py-3 bg-ink-50/50 rounded-lg border border-ink-100 focus:bg-white focus:border-accent-blue focus:ring-2 focus:ring-accent-blue/10 outline-none transition-all duration-300 text-sm font-medium text-ink-700 placeholder-ink-300" placeholder="yourname@example.com" />
                                            </div>
                                        </div>
                                        <div className="space-y-1.5">
                                    ...
                                    <button type="submit" className="group w-full relative overflow-hidden bg-ink-900 text-cream-50 px-6 py-4 rounded-lg font-heading text-sm font-bold shadow-lg hover:shadow-accent-blue/20 hover:-translate-y-0.5 transition-all duration-300">
                                        <div className="absolute inset-0 bg-gradient-to-r from-accent-blue to-accent-teal opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
